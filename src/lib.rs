...
#[derive(Debug)]
pub struct TerraLunaProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TerraLunaProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TerraLuna processing");
    
    let mut processor = TerraLunaProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TerraLunaProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TerraLunaProcessor::new(false);
